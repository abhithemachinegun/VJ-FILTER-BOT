        ...
        if manual == False:
            ...
            try:
                if settings['auto_ffilter']:
                    ai_search = True
                    reply_msg = await message.reply_text(f"<b><i>Searching Please Wait 🔍</i></b>")
    ...
    if save == True and SAVE_RESTRICTED_MODE == True:
        try:
            ...
            if not link:
                ...
                if PM_SEARCH == True:
                    ai_search = True
                    reply_msg = await bot.send_message(message.from_user.id, f"<b><i>Searching Please Wait 🔍</i></b>", reply_to_message_id=message.id)
                    await auto_filter(bot, content, message, reply_msg, ai_search)
                else:
                    await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/+A01i15IKwBRiNjdl>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+A01i15IKwBRiNjdl")]]))
    ...
    if gl == False:
        ...
        if k == False:
            ...
            if files:
                ...
                ai_search = True
                reply_msg = await query.message.edit_text(f"<b><i>Searching Please Wait 🔍</i></b>")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url="https://t.me/abhi_the_machinegun")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/abhi_the_machinegun")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
